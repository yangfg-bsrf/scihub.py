...
@author zaytoun
@follower_author Jango (date:2018-12-02)
In this version, I make a single profile to setup.It's more easily to edit paper_url in begin.
"""
paper_url=('10.1029/2018JD028388 ',
...
if __name__ == '__main__':
    main()
    sh = SciHub()
    for i in range(len(paper_url)):
        print(paper_url[i])
        sh.download(paper_url[i])
